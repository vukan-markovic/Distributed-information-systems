...
public class Player {
    ...
    public Player(int playerId, String name, String surname, String registrationNumber, String dateOfBirth, int nationalteamId, int nationalityId, int teamId, int leagueId, String serviceAddress) {
