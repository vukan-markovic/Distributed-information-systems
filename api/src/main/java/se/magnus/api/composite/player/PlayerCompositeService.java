...
public interface PlayerCompositeService {
     ...
     * '{"playerId":123,"name":"Cristiano","surname":"Ronaldo","registrationNumber":"324343","dateOfBirth":"1980-01-21","nationalityId":1,"teamId":1,"nationalteamId":1,"leagueId":1}'
     *
     * @param body
     */
    @ApiOperation(
    ...
    void createCompositePlayer(@RequestBody PlayerAggregate body);
    ...
    PlayerAggregate getCompositePlayer(@PathVariable int playerId);
    ...
    void deleteCompositePlayer(@PathVariable int playerId);
}