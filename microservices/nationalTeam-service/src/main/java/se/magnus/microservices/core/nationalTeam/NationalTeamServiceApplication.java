...
public class NationalTeamServiceApplication {
    ...
    public void initIndicesAfterStartup() {
        ...
        ReactiveIndexOperations indexOps = mongoTemplate.indexOps(NationalTeamEntity.class);
        resolver.resolveIndexFor(NationalTeamEntity.class).forEach(e -> indexOps.ensureIndex(e).block());
    }
}